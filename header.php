...
<div id="header">
    ...
    <h2 style="color: white;position: absolute">
        <a href="dashboard.php" style="color:white; margin-left: 30px; margin-top: 40px">SupplySync</a>
    </h2>
</div>
...
<div id="sidebar">
    <ul>
        ...
        <li>
            <a href="view_bills.php"><i class="icon icon-home"></i><span>Sales Report</span></a>
        </li>
        <li>
